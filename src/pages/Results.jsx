...
export default function Results() {
  ...
  const presidentialData = [
    { name: "Jane Smith", votes: 1234, percentage: 42, party: "Progressive Party" },
    { name: "John Doe", votes: 987, percentage: 33, party: "Conservative Party" },
    { name: "Alex Johnson", votes: 456, percentage: 15, party: "Liberty Party" },
    { name: "Maria Garcia", votes: 321, percentage: 10, party: "Green Party" },
  ]

  const localData = [
    { name: "Robert Wilson", votes: 567, percentage: 38, party: "Progressive Party" },
    { name: "Sarah Lee", votes: 432, percentage: 29, party: "Conservative Party" },
    { name: "David Kim", votes: 321, percentage: 21, party: "Liberty Party" },
    { name: "Lisa Chen", votes: 178, percentage: 12, party: "Green Party" },
  ]

  const schoolData = [
    { name: "Michael Brown", votes: 345, percentage: 45, party: "Progressive Party" },
    { name: "Jennifer White", votes: 234, percentage: 30, party: "Conservative Party" },
    { name: "Thomas Clark", votes: 123, percentage: 16, party: "Liberty Party" },
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-400">View the results of past and ongoing elections</p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden p-6 mb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Vote Distribution</h2>
            <div className="h-80">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Vote Counts</h2>
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart
                  data={data}
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
        <div className="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
          <h3 className="text-lg font-medium text-gray-900 dark:text-white">Detailed Results</h3>
        </div>
